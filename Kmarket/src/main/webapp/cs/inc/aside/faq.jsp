		...
		<nav>
			<div>
				<p>
					...
					<a href="${path }/cs/faqBoard/list.do?group=faq&cate=member">자주묻는 질문</a>
				</p>
			</div>
		</nav>
			...
			<aside>
				...
				<ul>
					<li class="${cate eq 'member' ? 'on' : '' }">
					    <a href="${path }/cs/faqBoard/list.do?group=faq&cate=member">회원</a>
					</li>
					<li class="${cate eq 'coupon' ? 'on' : '' }">
					    <a href="${path }/cs/faqBoard/list.do?group=faq&cate=coupon">쿠폰/이벤트</a>
					</li>
					<li class="${cate eq 'order' ? 'on' : '' }">
					    <a href="${path }/cs/faqBoard/list.do?group=faq&cate=order">주문/결제</a>
					</li>
					<li class="${cate eq 'delivery' ? 'on' : '' }">
					    <a href="${path }/cs/faqBoard/list.do?group=faq&cate=delivery">배송</a>
					</li>
					<li class="${cate eq 'cancle' ? 'on' : '' }">
					    <a href="${path }/cs/faqBoard/list.do?group=faq&cate=cancle">취소/반품/교환</a>
					</li>
