        ...
        <div class="type">
            <div class="normal">
                ...
                <div class="txt">
                    ...
                    <a href="${path}/member/signup.do?type=normal"><img src="./img/member_join_btn1.gif" alt="회원가입"></a>
                </div>
            </div>
            <div class="seller">
                ...
                <div class="txt">
                    ...
                    <a href="${path}/member/signup.do?type=seller"><img src="./img/member_join_btn2.gif" alt="회원가입"></a>
                </div>
            </div>
        </div>
