    ...
    <section class="list">
      ...
      <table>     
        ...
        <tr>
          ...
          <td>
            ...
            <a href="${path }/product/view.do?prodNo=${product.prodNo}&cate1=${product.prodCate1}&cate2=${product.prodCate2}" class="desc">${product.descript }</a>
          </td>
          <td>
            <ul>
      ...
      <div class="paging">
        ...
        <c:forEach var="i" begin="${pageGroupStart }" end="${pageGroupEnd }">
	        <span class="num">
	          <a href="${path }/product/search.do?pg=${i}&search=${search}" class="${i eq pg ? 'on' : '' }">${i }</a>
	        </span>
        </c:forEach>
